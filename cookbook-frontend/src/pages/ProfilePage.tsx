...
export default function ProfilePage() {
 ...
 <img src="https://www.shutterstock.com/image-vector/blank-avatar-photo-place-holder-600nw-1095249842.jpg" alt="Default PFP" className="w-full h-full object-cover transition-transform group-hover:scale-110"/>
 )}
 </div>
 ...
 onChange={(val) => setProfileForm({ ...profileForm, profilePictureUrl: val })}
 type="pfp"
 />
 </div>
 <div>
